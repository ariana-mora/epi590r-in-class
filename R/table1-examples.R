...
# include is defining stratification/categorical variables
tbl_summary(
	nlsy,
	by = sex_cat,
...
# the sleep variables (use a helper function to select those) and make sure they are nicely labeled.
